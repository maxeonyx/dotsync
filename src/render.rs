...
use dotsync::{CascadePause, DotsyncError, ErrorReport, FileDrift};
use serde_json::json;
use std::path::Path;
...
pub(crate) fn render_error_human(error: &DotsyncError) -> String {
    ...
    match error {
        DotsyncError::CommitSelectionRequired => render_structured_error(
        ...
        DotsyncError::ConflictingCommitSelection => render_structured_error(
        ...
        DotsyncError::CommitSelectionEmpty => render_structured_error(
        ...
        DotsyncError::CommitPathOutsideRepo { .. } => render_structured_error(
        ...
        DotsyncError::CommitPathMissing { .. } => render_structured_error(
            "commit path missing",
        ...
        DotsyncError::ConfigOnlyAllowedOnBaseScope { .. } => render_structured_error(
        ...
        DotsyncError::NoPausedCascade => render_structured_error(
            "nothing to resume",
        ...
        DotsyncError::CascadeInProgress { .. } => render_structured_error(
            "already paused",
        ...
        DotsyncError::ScopeNotAncestor { .. } => render_structured_error(
            "not an ancestor",
